...
namespace ACBr.Net.Core
{
    ...
    public static class XmlDocumentExtensions
    {
        ...
        public static string AsString(this XmlDocument xmlDoc, bool identado = false)
        {
            return xmlDoc.AsString(identado, Encoding.UTF8);
        }
        ...
        /// <returns>System.String.</returns>
        public static string AsString(this XmlDocument xmlDoc, bool identado, Encoding encode)
        {
            using (var stringWriter = new StringWriter())
            {
                using (var xmlTextWriter = XmlWriter.Create(stringWriter))
                {
                    ...
                    xmlTextWriter.Flush();
                    xmlTextWriter.Settings.Indent = identado;
                    xmlTextWriter.Settings.Encoding = encode;
